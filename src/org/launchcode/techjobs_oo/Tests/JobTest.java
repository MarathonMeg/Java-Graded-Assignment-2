...
//        assertTrue(job3.getCoreCompetency()instanceof CoreCompetency && job3.getCoreCompetency().getValue().equals("Persistence"));
    ...
    @Test
    public void toStringReadsDataNotAvailableWhenBlank(){
        Job job7 = new Job("Java Back End Developer", new Employer("Microsoft"), new Location("San Jose"), new PositionType("Software Engineer"), new CoreCompetency("Java"));
        String job7Str = job7.toString();

        //assertEquals("Data not available", job7Str);
    }
